...
|---|---|---|---|---|
| MVP-0.1 | Todo | Add version catalog entries and Gradle plugins for Hilt, Room, KSP, DataStore, Navigation, Serialization, WorkManager test-ready stack. | None | Project syncs and `assembleDebug` succeeds. |
